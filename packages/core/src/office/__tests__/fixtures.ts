  ...
  return {
    ...
    worksheets: [{
      ...
      cells: [
        ...
        ...['Units', 'Price', 'Total'].map((value, i) => ({ id: id(801 + i), address: `${String.fromCharCode(65 + i)}12`, valueType: 'string' as const, value, style: {}, locked: false })),
        { id: id(804), address: 'A13', valueType: 'number', value: 2, style: { fill: '#ECFDF5' }, locked: false },
        { id: id(805), address: 'B13', valueType: 'number', value: 3, style: {}, locked: false },
        { id: id(806), address: 'C13', valueType: 'number', value: null, formula: 'A13*B13', calculatedValue: 6, style: {}, locked: false },
      ],
      tables: [{ id: id(800), name: 'Records', ref: 'A12:C13', autoFilter: true, columns: [{ id: 1, name: 'Units' }, { id: 2, name: 'Price' }, { id: 3, name: 'Total' }], style: { name: '', showFirstColumn: false, showLastColumn: false, showRowStripes: false, showColumnStripes: false } }],
      merges: ['A1:C1'],
